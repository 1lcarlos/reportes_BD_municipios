--Con_4.7.3.sql
--Consulta de unidades de construccion con tipo de construccion Convencional y tipo de calificar Industrial
--que tienen campos no nulos en los subtotales de cocina o baño
SELECT        
    ...
    WHERE ct.iliCode = 'Convencional'  and ct2.ilicode in ('Industrial') and
    (cc3.subtotal_cocina is not null or cc3.subtotal_banio is not null)