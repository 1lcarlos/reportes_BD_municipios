--Cond 4.7.2.sql
--- Reporte de unidades de construccion con tipo de construccion Convencional y tipo de calificar Industrial
--- que tienen campos nulos en los subtotales de estructura, acabados o cerchas    
    SELECT        
    ...
    or cc3.subtotal_cerchas is null)