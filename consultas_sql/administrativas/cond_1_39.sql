...
from cca_predio lp
inner join tb_cond_1_39_1 tt on tt.t_id=lp.t_id
...
case WHEN coalesce(pp.unidades_prediales_area_privada_cosntruida_total,0)=coalesce(tb1.area_total_construida_privada,0) and coalesce(tb1.area_total_construida_privada,0)<>0 THEN 'Ok'
else 'Fail' end as cond_1_39
from tb_cond_1_39_1 tb1
