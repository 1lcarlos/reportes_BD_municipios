...
predios_asociados AS (
    SELECT 
        ...
        MAX(SUBSTR(lp2.numero_predial, 25, 2)) OVER (PARTITION BY lp.t_id) AS torre
    FROM cca_predio lp
    INNER JOIN tb_cond_1_33_1 tt ON tt.t_id = lp.t_id
