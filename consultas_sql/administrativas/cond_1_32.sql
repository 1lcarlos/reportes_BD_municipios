--cond 1_32
with tb_cond_1_32_1 as (
select 
lp.t_id 
,lp.numero_predial
,lp.area_total_construida_comun 
from cca_predio lp
...
from cca_predio lp
inner join tb_cond_1_32_1 tt on tt.t_id=lp.t_id
...
select 
tb1.numero_predial,
tb1.area_total_construida_comun,
pp.unidades_prediales_area_construida_total, 
case when tb1.area_total_construida_comun is null or pp.unidades_prediales_area_construida_total is null  then 'Fail'
when tb1.area_total_construida_comun = pp.unidades_prediales_area_construida_total then 'Ok' 
else 'Fail' end as cond_1_32
from tb_cond_1_32_1 tb1
