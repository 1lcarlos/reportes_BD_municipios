--cond 1_30
with tb_cond_1_30_1 as (
select 
lp.t_id 
,lp.numero_predial
,lp.area_total_construida
from cca_predio lp
...
from cca_predio lp
inner join tb_cond_1_30_1 tt on tt.t_id=lp.t_id
...
select 
tb1.numero_predial,
tb1.area_total_construida,
pp.unidades_prediales_area_construida_total,
pp.unidades_prediales_area_privada_cosntruida_total, 
case when tb1.area_total_construida is null then 'Fail'
when pp.unidades_prediales_area_construida_total is null and pp.unidades_prediales_area_privada_cosntruida_total is null then 'Fail'
when tb1.area_total_construida = pp.unidades_prediales_area_construida_total + pp.unidades_prediales_area_privada_cosntruida_total then 'Ok' 
else 'Fail' end as cond_1_30
from tb_cond_1_30_1 tb1
