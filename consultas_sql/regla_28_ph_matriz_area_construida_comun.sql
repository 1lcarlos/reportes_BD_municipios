-- =========================================================
-- REGLA 28: Área total construida común para PH.Matriz
-- =========================================================
-- Descripción:
-- Para predios con condición PH.Matriz (posición 22-30 = "900000000"),
-- el área total construida común debe ser la sumatoria de las
-- áreas de las unidades de construcción del PH matriz
-- =========================================================

-- Consulta que verifica el área construida común para PH.Matriz
SELECT
    p.t_id,
    p.numero_predial,
    cpt.ilicode AS condicion_predio,
    p.area_total_construida_comun,
    calc.suma_areas_comunes,
    ABS(COALESCE(p.area_total_construida_comun, 0) - COALESCE(calc.suma_areas_comunes, 0)) AS diferencia,
    'Error: El área total construida común no corresponde a la suma de áreas del predio matriz' AS mensaje_error
FROM cca_predio p
